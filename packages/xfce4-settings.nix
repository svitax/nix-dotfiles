# NOTE 2026-01-14: nixpkgs added xapp as a dependency to xfce4-settings, which
# keeps wanting to pull in all of mate-desktop and wayland. Here I remove that
# dependency (and xfce4-settings keeps working fine without it).
{
  stdenv,
  lib,
  fetchFromGitLab,
