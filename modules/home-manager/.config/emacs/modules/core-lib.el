...
(defmacro put-safe-local-variables! (variables &rest args)
  "For each variable in `variables', put its value safe for local variables. The
type will need to be passed as args."
