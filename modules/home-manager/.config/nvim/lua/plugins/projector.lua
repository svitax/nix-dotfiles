...
return {
    {
        ...
        opts = function()
            ...
            vim.keymap.set( "n", "<leader>gx", "<cmd>lua require('projector').kill()<cr>", { desc = "Kill task/debug session" }
            ) -- kill task
            ...
            return {
                loaders = {
                    ...
                    {
                        module = "builtin",
                        options = { path = vim.fn.getcwd() .. "/.vscode/projector.json", configs = configs },
                    },
                },
