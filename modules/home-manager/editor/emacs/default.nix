        ...
        editor.emacs.package = pkgs.emacsWithPackagesFromUsePackage {
          ...
          override =
            ...
            // {
              ...
              macrursors = elPackage "macrursors" (
                pkgs.fetchFromGitHub {
                  owner = "corytertel";
                  repo = "macrursors";
              ...
              visual-replace = elPackage "visual-replace" (
                pkgs.fetchFromGitHub {
                  owner = "szermatt";
                  repo = "visual-replace";
              ...
              eglot-booster = elPackage "eglot-booster" (
                pkgs.fetchFromGitHub {
                  owner = "jdtsmith";
                  repo = "eglot-booster";
              ...
              org-block-capf = elPackage "org-block-capf" (
                pkgs.fetchFromGitHub {
                  owner = "xenodium";
                  repo = "org-block-capf";
              ...
              org-src-context = elPackage "org-src-context" (
                pkgs.fetchFromGitHub {
                  owner = "karthink";
