...
;; FIXME: this function is undefined and causes a redisplay error when i first
;; load an emacs-lisp-file with the modifications in this file. defining it here
;; bypasses the issue. no idea how to fix this.
