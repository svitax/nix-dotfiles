...
(use-package avy
  ...
  (general-omap "z" 'evil-avy-goto-char-timer)
  (general-vmap "z" 'evil-avy-goto-char-timer))
...
(use-package modus-themes
  :demand t
  :general (global-definer "H" 'sx-cycle-theme)
  :init
...
This function is added to the `modus-themes-post-load-hook'."
  ...
  (add-hook 'after-load-theme-hook #'modus-themes-custom-faces)
...
This function is added to the `ef-themes-post-load-hook'."
  ...
  (add-to-list 'sx-themes-list 'ef-arbutus))
...
(use-package doom-modeline
  ...
  (doom-modeline-def-modeline
   'my-modeline
   '(eldoc matches buffer-name remote-host misc-info)
...
(use-package eglot
  ...
  (eglot-managed-mode . sx/eglot-remove-mode-line-misc-info)
  :init
  ...
  (defun sx/eglot-remove-mode-line-misc-info ()
...
time the command took to complete in seconds."
    ...
    (concat
     " "
     (all-the-icons-material "av_timer" :v-adjust -0.1)
     " "
     (format "%.1fs" duration)))
