;;; dired-sort-by.el --- Dired Sort By            -*- lexical-binding: t; -*-
...
;; dired-sort-by is a set of functions that provide richer sorting
...
;; init file.
;;
;; (require 'dired-sort-by)
;; (define-key dired-mode-map (kbd "s") 'dired-sort-by)
;;
...
(transient-define-prefix dired-sort-by ()
...
(provide 'dired-sort-by)
;;; dired-sort-by.el ends here
